            ...
            <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex justify-between items-end mb-8">
                    <div>
                        ...
                        <div className="w-16 h-0.5 bg-[#111827]"></div>
                    </div>

                    {/* Mobile Swipe Hint */}
                    <div className="sm:hidden flex items-center gap-1 text-[#111827] text-xs font-medium animate-pulse">
                    ...
                    <div className="hidden sm:flex gap-2">
                        <button
                            onClick={() => scroll('left')}
                            className="p-2 rounded-full border border-gray-300 hover:border-[#111827] hover:text-[#111827] transition-colors"
                        >
                ...
                >
                    {products.map((product) => (
                        ...
                        >
                            <Link to={`/product/${product._id}`} className="block h-full border border-gray-100 rounded-xl overflow-hidden hover:shadow-lg hover:border-[#111827]/20 transition-all duration-300 bg-white">
                                ...
                                <div className="p-5">
                                    ...
                                    <h3 className="text-gray-900 font-serif text-lg mb-3 leading-tight group-hover:text-[#111827] transition-colors line-clamp-1">{product.name}</h3>

                                    <div className="flex items-center justify-between mt-4">
                                        <p className="text-[#111827] font-bold text-lg">₹{product.price.toLocaleString()}</p>
                                        <button className="w-8 h-8 rounded-full bg-[#f9f5f1] text-[#5c4033] flex items-center justify-center hover:bg-[#111827] hover:text-white transition-all duration-300">
