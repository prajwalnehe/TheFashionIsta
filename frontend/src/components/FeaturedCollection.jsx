        ...
        <section className="w-full bg-white py-12 sm:py-16">
            <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-10 sm:mb-14">
                    ...
                    <div className="w-16 sm:w-20 h-0.5 bg-[#111827] mx-auto"></div>
                </div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                    {features.map((item) => (
                        <Link to={`/products?category=${item.category}`} key={item.id} className="group cursor-pointer">
                            ...
                            {/* Title */}
                            <h3 className="text-lg font-medium text-gray-800 group-hover:text-[#111827] transition-colors text-center">
                                {item.title}
                            </h3>
                        </Link>
                    ))}
