        ...
        <section className="w-full bg-white py-16 sm:py-20 border-b border-gray-100">
            <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-end mb-10">
                    <div>
                        <span className="text-[#111827] font-bold tracking-widest uppercase mb-2 block">Curated Styles</span>
                        <h2 className="text-3xl sm:text-4xl font-serif text-gray-900">The 2026 Lookbook</h2>
                    </div>
                    <Link to="/products" className="text-[#5c4033] border-b border-[#5c4033] pb-0.5 hover:text-[#111827] hover:border-[#111827] transition-colors mt-4 md:mt-0 font-medium">
                    ...
                    {looks.map((look, idx) => (
                        <div key={idx} className="group relative overflow-hidden">
                            ...
                            <div className="absolute bottom-0 left-0 w-full p-6 text-white transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                                ...
                                <Link to={look.link} className="inline-flex items-center text-sm font-bold uppercase tracking-wide border-b border-white pb-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-200 hover:text-[#111827] hover:border-[#111827]">
                                    Discover
                                </Link>
                            </div>
                        </div>
