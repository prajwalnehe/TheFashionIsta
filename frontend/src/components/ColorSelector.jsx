        ...
        <div className="mb-6">
            ...
            <div className="mb-4">
                <div className="text-sm font-medium text-gray-900 mb-3">
                    Select Fabric Type: <span className="text-[#111827] font-bold">{selectedFabric}</span>
                </div>
            ...
            <div className="mb-2">
                <div className="text-sm font-medium text-gray-900 mb-3">
                    Select Color:
                    <span className="text-[#111827] font-bold ml-2">
                            ...
                            <div key={colorData.code} className="relative group">
                                ...
                                <button
                                    ...
                                    className={`w-9 h-9 rounded-md transition-all duration-200 ${isSelected
                                        ? 'ring-2 ring-[#111827] ring-offset-2 scale-110 shadow-md'
                                        : 'ring-1 ring-gray-200 hover:ring-[#111827] hover:scale-105 hover:shadow-sm'
                                        }`}
