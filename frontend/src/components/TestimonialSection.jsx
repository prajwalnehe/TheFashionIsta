...
const TestimonialSection = () => {
    const reviews = [
        ...
        },
        {
            ...
            text: "I was skeptical about buying fashion online, but TheFashionIsta exceeded my expectations. The fit options helped me find exactly what I wanted for my wardrobe."
        },
        {
            id: 3,
            name: "Priya Sharma",
        ...
        <section className="w-full bg-[#fcfcfc] py-16 sm:py-24">
            <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    <span className="text-[#111827] font-bold tracking-widest uppercase mb-2 block">Testimonials</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {reviews.map((review) => (
                        <div key={review.id} className="bg-white p-8 rounded-xl shadow-sm hover:shadow-xl transition-shadow border border-gray-100 relative">
                            ...
                            {/* Stars */}
                            <div className="flex text-[#111827] mb-6 relative z-10">
                                {[...Array(5)].map((_, i) => (
                            ...
                            <div className="flex items-center gap-4">
                                <img src={review.image} alt={review.name} className="w-12 h-12 rounded-full object-cover border-2 border-[#111827]/20" />
                                <div>
