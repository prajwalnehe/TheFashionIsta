        ...
        <section className="w-full bg-white py-16 sm:py-20">
            <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-end mb-12">
                    <div>
                        <span className="text-[#111827] font-bold tracking-widest uppercase mb-2 block">Shop by Room</span>
                        <h2 className="text-3xl sm:text-4xl font-serif text-gray-900">Curate Your Space</h2>
                    </div>
                    <Link to="/products" className="group flex items-center gap-2 text-[#5c4033] font-medium hover:text-[#111827] transition-colors mt-4 md:mt-0">
                        View All Spaces
