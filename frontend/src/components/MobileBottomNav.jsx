        ...
        },
        {
            ...
            icon: (active) => (
                <div className="relative">
                    ...
                    {cartCount > 0 && (
                        <span className="absolute -top-2 -right-2 bg-[#111827] text-white text-[9px] font-bold rounded-full h-4 w-4 flex items-center justify-center">
        ...
        <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] z-[60] pb-safe">
            <div className="flex justify-around items-center h-16">
                {navItems.map((item) => {
                    ...
                    const Content = () => (
                        <div className={`flex flex-col items-center gap-1 transition-colors duration-200 ${active ? 'text-[#111827]' : 'text-gray-400 hover:text-gray-600'}`}>
                            {item.icon(active)}
