    ...
    const qualities = [
        {
            ...
            description: "We source high-grade cotton, linen, satin blends, and performance fabrics that hold shape, feel luxurious, and remain comfortable through every season.",
            icon: (
        ...
        },
        {
            ...
            description: "From structured silhouettes to clean seam finishes, every piece is cut and stitched by skilled artisans for a refined fit and long-lasting wear.",
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        },
        {
            ...
            description: "Each design goes through detailed finishing, trims, and quality checks to ensure rich color depth, flawless detailing, and elevated everyday style.",
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex flex-col lg:flex-row gap-16 items-center">
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif mb-6">
                            Uncompromising <br />
                            <span className="italic text-[#d4c4b7]">Fashion Craft</span>
                        </h2>
                        <p className="text-gray-300 text-lg mb-8 leading-relaxed">
                            At Elitewear, every garment is more than clothing - it is a statement of confidence. We blend timeless tailoring principles with modern design to create fashion that feels premium and lasts beyond trends.
                        </p>

                        <div className="space-y-8">
                            {qualities.map((item, index) => (
                                <div key={index} className="flex gap-4">
                                    <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#111827] border border-[#111827]/30 flex items-center justify-center text-[#d4c4b7]">
                                        {item.icon}
                                    </div>
                                    <div>
                    ...
                    <div className="w-full lg:w-1/2">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-4 mt-8">
                                ...
                                />
                                <div className="bg-[#111827] p-5 rounded-sm border border-[#111827]/20">
                            ...
                            <div className="space-y-4">
                                <div className="bg-[#111827] p-5 rounded-sm border border-[#111827]/20 h-36 flex items-center justify-center text-center">
