        ...
        return (
            <div className="min-h-screen bg-gray-100 flex items-center justify-center py-12">
                <div className="text-center max-w-md px-4">
                    ...
                    <Link
                        to="/products"
                        className="inline-block px-8 py-3 bg-[#111827] text-white font-semibold rounded-lg hover:bg-[#1f2937] transition-colors shadow-md hover:shadow-lg"
                    >
                        Shop Now
                    </Link>
                </div>
                        ...
                        {cartItems.length > 0 && (
                            <div className="bg-white rounded-sm shadow-sm mb-4">
                                <div className="px-4 md:px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                                    ...
                                    <Link to="/products" className="text-sm text-[#111827] font-medium hover:text-[#1f2937]">
                                        + Add More Items
                                    </Link>
                                </div>
                                                ...
                                                <div className="flex gap-4">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <div className="flex justify-between gap-4 mb-2">
                                                            <div className="flex-1">
                                                                <Link to={`/product/${product._id || item.product}`} className="text-base md:text-lg font-medium text-gray-900 hover:text-[#111827] line-clamp-2">
                                                                    {productName}
                                                                </Link>
                                                        ...
                                                        <div className="flex items-center gap-3 mb-3">
                                                            ...
                                                            <span className="text-sm text-[#111827] font-bold">25% off</span>
                                                        </div>
                                                        ...
                                                        <div className="flex items-center gap-2 text-sm text-gray-600 mb-3">
                                                            ...
                                                            {deliveryCharges === 0 && <span className="text-[#111827] font-bold ml-2">FREE</span>}
                                                        </div>
                                                        ...
                                                        <div className="flex items-center gap-4 flex-wrap">
                                                            ...
                                                            <button
                                                                ...
                                                                className="text-sm font-medium text-gray-700 hover:text-[#111827] transition-colors"
                                                            >
                                                                SAVE FOR LATER
                                                            </button>
                                                        </div>
                                                ...
                                                <div className="flex gap-4">
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        <div className="flex items-center gap-3 mb-3">
                                                            ...
                                                            <span className="text-xs text-[#111827] font-bold">25% OFF</span>
                                                        </div>
                                                        <div className="flex gap-4">
                                                            <button
                                                                onClick={() => moveToCart(item._id)}
                                                                className="text-sm font-medium text-[#111827] hover:text-[#1f2937] transition-colors"
                                                            >
                                                                MOVE TO CART
                                                            </button>
                                                            <button
                            ...
                            <div className="bg-white rounded-sm shadow-sm sticky top-20">
                                ...
                                <div className="p-6 space-y-4">
                                    ...
                                    <div className="flex justify-between text-base">
                                        ...
                                        <span className="font-medium text-[#111827]">− ₹{discount.toLocaleString()}</span>
                                    </div>
                                    ...
                                    <div className="text-sm text-[#111827] font-medium bg-[#111827]/10 p-3 rounded-sm">
