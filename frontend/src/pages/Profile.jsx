            ...
            <div className="min-h-screen bg-gray-100 flex items-center justify-center py-12">
                <div className="text-center max-w-md px-4 w-full">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                        <Link
                            to="/login"
                            className="w-full sm:w-auto inline-block px-8 py-3 bg-[#111827] text-white font-semibold rounded-lg hover:bg-[#1f2937] transition-colors shadow-md hover:shadow-lg text-center"
                        >
                            Login
                        </Link>
                        <Link
                            to="/signup"
                            className="w-full sm:w-auto inline-block px-8 py-3 border-2 border-[#111827] text-[#111827] font-semibold rounded-lg hover:bg-[#111827] hover:text-white transition-colors text-center"
                        >
                            Sign Up
                        </Link>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-0">
                        <div className="flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
                            <div className="relative">
                                <div className="w-20 h-20 bg-[#111827] rounded-full flex items-center justify-center text-white text-2xl font-bold shrink-0 ring-4 ring-gray-50">
                                    {user?.name?.charAt(0).toUpperCase() || 'U'}
                                </div>
                                <button className="absolute bottom-0 right-0 bg-white rounded-full p-1.5 shadow-md border border-gray-100 text-gray-500 hover:text-[#111827]">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <Link to="/orders" className="bg-[#111827] rounded-xl p-4 sm:p-6 text-white shadow-lg shadow-orange-900/10 hover:shadow-xl hover:translate-y-[-2px] transition-all relative overflow-hidden group">
                            ...
                            <Link to="/cart" className="bg-white rounded-xl p-4 sm:p-6 border border-gray-100 shadow-sm hover:shadow-md hover:border-[#111827]/30 transition-all group">
                                    ...
                                    <form onSubmit={async (e) => {
                                        ...
                                        <div className="group">
                                            ...
                                            <input
                                                ...
                                                className="w-full p-3 border border-[#111827] rounded-lg focus:ring-1 focus:ring-[#111827] outline-none bg-white"
                                                required
                                            />
                                        </div>
                                        ...
                                        <div className="flex gap-3 pt-4">
                                            ...
                                            <button
                                                type="submit"
                                                className="flex-1 py-2 bg-[#111827] text-white rounded-lg hover:bg-[#1f2937] font-bold"
                                                disabled={updateLoading}
                                            >
