...
const ProductDetail = () => {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-100">
                <div className="text-center">
                    ...
                    <Link to="/products" className="text-[#111827] hover:text-[#1f2937] font-semibold">
                        Back to Products
                    </Link>
                </div>
            </div>
    ...
    const displayCategory = (category) => {
        return displayCategoryMap[category] || category
    }
                ...
                <div className="flex flex-col md:flex-row">
                        ...
                        <div className="flex flex-col relative">
                                ...
                                <div className="hidden md:flex flex-col gap-2 w-16 mr-2 h-[450px] overflow-y-auto scrollbar-hide">
                                    {images.map((img, idx) => (
                                        <div
                                            ...
                                            className={`w-16 h-16 border-2 cursor-pointer p-1 rounded-sm ${selectedImage === idx ? 'border-[#111827]' : 'border-gray-200 hover:border-[#111827]'}`}
                                        >
                            ...
                            <div className="flex md:hidden gap-2 mt-4 overflow-x-auto pb-2">
                                {images.map((img, idx) => (
                                    <div
                                        ...
                                        className={`w-16 h-16 flex-shrink-0 border-2 rounded-sm ${selectedImage === idx ? 'border-[#111827]' : 'border-gray-200'}`}
                                    >
                                        <img src={img} alt="" className="w-full h-full object-contain" />
                                    </div>
                                ))}
                            ...
                            <div className="flex gap-4 mt-6">
                                <button
                                    ...
                                    className="flex-1 py-4 bg-[#a67c52] hover:bg-[#111827] text-white font-bold text-base uppercase shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2 rounded-sm disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {addingToCart ? (
                                        <>
                                ...
                                <button
                                    ...
                                    disabled={addingToCart}
                                    className="flex-1 py-4 bg-[#111827] hover:bg-[#3e2b22] text-white font-bold text-base uppercase shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2 rounded-sm disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {addingToCart ? (
                                        <>
                                            <svg className="animate-spin h-5 w-5 text-white" fill="none" viewBox="0 0 24 24">
                    ...
                    <div className="w-full md:w-[60%] lg:w-[65%] p-4 md:pl-8 border-l border-gray-100 flex-1">
                        ...
                        <div className="flex items-center text-xs text-gray-500 mb-2 gap-1">
                            ...
                            <span>›</span>
                            <Link to="/products" className="hover:text-[#111827]">Furniture</Link>
                            <span>›</span>
                            <Link to={`/products?category=${product.category}`} className="hover:text-[#111827]">{displayCategory(product.category)}</Link>
                            <span>›</span>
                        ...
                        <div className="flex items-center gap-3 mb-3">
                            <div className="flex items-center gap-1 bg-[#111827] text-white text-xs font-bold px-1.5 py-0.5 rounded-sm">
                        ...
                        <div className="flex items-end gap-3 mb-4">
                            ...
                            <span className="text-[#111827] text-base font-bold">25% off</span>
                        </div>
                        ...
                        <div className="border border-gray-200 rounded-sm mb-6">
                            ...
                            <div className="p-5 text-sm text-gray-700 leading-relaxed">
                                {product.description}
                                <br /><br />
                                <p>Whether you are looking to refresh your everyday wardrobe or statement look, this piece from TheFashionIsta is designed to meet your highest standards of comfort and style. We use only selected materials to ensure longevity and class.</p>
                            </div>
                        </div>
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <div className="border border-gray-200 rounded-sm">
                                            ...
                                            {selectedVariant?.dimensions && (
                                                <div className="bg-[#fff8f5] border-b border-[#111827]/20">
                                                    <div className="grid grid-cols-3">
                                                        <div className="p-3 text-sm font-medium text-[#111827] col-span-1">Selected Configuration</div>
                                                        <div className="p-3 text-sm font-bold text-[#111827] col-span-2">
                                                            {selectedVariant.dimensions}
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div className="border border-gray-200 rounded-sm mb-6">
                            <div className="px-5 py-4 border-b border-gray-200 flex justify-between items-center">
                                ...
                                <button className="px-5 py-2 bg-white shadow border border-[#111827] text-sm font-medium text-[#111827] hover:bg-[#111827] hover:text-white transition-colors hover:shadow-md">Rate Product</button>
                            </div>
                                    ...
                                    {[5, 4, 3, 2, 1].map(stars => (
                                        <div key={stars} className="flex items-center gap-4 text-sm">
                                            ...
                                            <div className="flex-1 h-1.5 bg-gray-200 rounded-full overflow-hidden">
                                                <div
                                                    className={`h-full rounded-full ${[1, 2].includes(stars) ? 'bg-[#111827]' : 'bg-[#111827]'}`}
