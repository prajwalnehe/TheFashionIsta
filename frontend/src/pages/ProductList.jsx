...
const ProductList = () => {
    ...
    const displayCategory = ((displayCategoryMap[selectedCategory] || selectedCategory || 'All')).toUpperCase()
                ...
                <div className="flex flex-col md:flex-row justify-between items-center mb-8">
                    ...
                    <div className="flex items-center gap-4 w-full md:w-auto">
                        ...
                        <select
                            ...
                            className="flex-1 md:flex-none px-4 py-2 border border-gray-200 rounded-lg bg-white text-sm focus:outline-none focus:ring-2 focus:ring-[#111827]"
                        >
                        ...
                        {loading && page === 1 ? (
                            ...
                            <div className="text-center py-20">
                                ...
                                <button
                                    ...
                                    className="px-6 py-2 bg-[#111827] text-white rounded-lg hover:bg-[#70482d]"
                                >
                                    Retry
                                </button>
                            </div>
                                        ...
                                        <Link to={`/product/${product._id || product.id}`} key={product._id || product.id} className="group">
                                            <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300">
                                                <div className="relative aspect-[4/3] overflow-hidden bg-gray-100">
                                                    ...
                                                    <button className="absolute bottom-4 right-4 bg-white p-2 rounded-full shadow-lg opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 hover:bg-[#111827]/10">
                                                ...
                                                <div className="p-5">
                                                    <div className="flex justify-between items-start mb-2">
                                                        <div className="text-xs font-medium text-[#111827] uppercase tracking-wide">{product.category}</div>
                                ...
                                {hasMore && (
                                    <div className="mt-12 flex justify-center">
                                        <button
                                            ...
                                            disabled={loading}
                                            className="px-8 py-3 bg-white border border-[#111827] text-[#111827] font-semibold rounded-full hover:bg-[#111827] hover:text-white transition-colors shadow-sm hover:shadow-md disabled:opacity-50"
                                        >
