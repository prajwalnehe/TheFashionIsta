        ...
        return (
            <div className="min-h-screen bg-gray-100 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <Link to="/" className="text-[#111827] hover:underline">Return Home</Link>
                </div>
            </div>
        )
    }
            ...
            <div className="max-w-5xl mx-auto px-4">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                    ...
                    <div className="flex gap-3">
                        ...
                        <Link to="/products" className="px-4 py-2 bg-[#111827] text-white rounded-lg hover:bg-[#70482d] transition-colors text-sm font-medium">
                            Continue Shopping
                        </Link>
                    </div>
                </div>
                                        ...
                                        return (
                                            <div key={step.key} className="flex md:flex-col items-center gap-4 md:gap-2">
                                                ...
                                                <div className={`w-6 h-6 rounded-full flex items-center justify-center border-2 bg-white z-10 
                                                    ${(isCompleted || isCurrent) ? 'border-[#111827]' : 'border-gray-300'}`}>

                                                    {isCompleted && (
                                                        <div className="w-3 h-3 bg-[#111827] rounded-full"></div>
                                                    )}
                                                    {isCurrent && (
                                                        <div className="w-3 h-3 bg-[#111827] rounded-full animate-pulse"></div>
                                                    )}
                                                    {isUpcoming && (
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-lg shadow-sm p-6">
                            ...
                            <div className="flex justify-between items-center pt-3">
                                ...
                                <span className="font-bold text-xl text-[#111827]">₹{order.total.toLocaleString()}</span>
                            </div>
                        </div>
                    </div>
                </div>
