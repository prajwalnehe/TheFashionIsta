    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            const options = {
                ...
                image: "https://thefashionista.com/logo.png", // Replace with actual logo if available
                ...
                notes: {
                    address: "TheFashionIsta Corporate Office"
                },
                theme: {
                    color: "#111827"
                },
                    ...
                    <div className="flex-1 space-y-4">
                        <div className="bg-white p-6 rounded-sm shadow-sm">
                            ...
                            <div className="space-y-4">
                                <label className="flex items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition-colors border-[#111827] bg-[#111827]/5">
                                    <input
                                        type="radio"
                                        name="payment"
                                        defaultChecked
                                        className="h-5 w-5 text-[#111827] focus:ring-[#111827]"
                                    />
                    ...
                    <div className="w-full md:w-80 h-fit bg-white p-6 rounded-sm shadow-sm">
                        ...
                        <div className="space-y-3 text-sm border-b border-gray-200 pb-4 mb-4">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className="text-[#111827] font-medium">{deliveryCharges === 0 ? 'FREE' : `₹${deliveryCharges}`}</span>
                            </div>
                        </div>
