        ...
        <div className="min-h-[80vh] flex items-center justify-center bg-gray-50 px-4">
            <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
                ...
                <div className="space-y-4">
                    <Link
                        to={`/order/${id}`}
                        className="block w-full py-3 bg-[#111827] text-white font-bold rounded-lg hover:bg-[#70482d] transition-colors shadow-md transform hover:scale-[1.02] duration-200"
                    >
                        TRACK YOUR ORDER
                    </Link>
