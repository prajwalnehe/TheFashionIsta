    ...
    if (!isAuthenticated) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-4">
                ...
                <Link to="/login" className="px-8 py-3 bg-[#111827] text-white font-bold rounded-lg hover:bg-[#70482d] transition-colors shadow-lg">
                    Login
                </Link>
            </div>
        )
        ...
        <div className="min-h-screen bg-gray-50 py-8">
            <div className="max-w-4xl mx-auto px-4">
                <div className="flex items-center justify-between mb-8">
                    ...
                    <Link to="/profile" className="text-sm font-medium text-[#111827] hover:underline">
                        Back to Profile
                    </Link>
                </div>
                ...
                {orders.length === 0 ? (
                    <div className="bg-white rounded-xl shadow-sm p-12 text-center">
                        ...
                        <Link to="/products" className="inline-block px-8 py-3 bg-[#111827] text-white font-bold rounded-lg hover:bg-[#70482d] transition-colors shadow-md hover:shadow-lg">
                            Start Shopping
                        </Link>
                    </div>
                ) : (
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="border-t border-gray-100 pt-4">
                                        <div className="flex flex-col sm:flex-row items-center gap-4">
                                            ...
                                            <Link
                                                to={`/order/${order._id}`}
                                                className="w-full sm:w-auto px-6 py-2 border border-gray-300 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-50 hover:text-[#111827] hover:border-[#111827] transition-colors text-center order-1 sm:order-2"
                                            >
                                                View Details
                                            </Link>
                                        </div>
